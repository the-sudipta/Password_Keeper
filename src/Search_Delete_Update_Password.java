...
public class Search_Delete_Update_Password extends javax.swing.JFrame {
    ...
    private void update_jButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_update_jButtonActionPerformed
        ...
        try {
            ...
            String _siteName = siteName_jTextField.getText();
            String _username = username_jTextField.getText();
            String _mail = mail_jTextField.getText();
            String _password = password_jTextField.getText();



            String sql = null;
            if(sNo != -1 && _siteName!=null && _username!=null && _mail!=null && _password!=null){
                sql = "UPDATE ALLPASSWORD SET siteName = '"+_siteName+"', username = '"+_username+"', mail = '"+_mail+"', password = '"+_password+"' WHERE id = '"+sNo+"' ";
            }else{
                System.out.println("Some Data could not be fetched from input field");
                JOptionPane.showMessageDialog(null, "Re-write all the input data for update");
            }
            ...
            JOptionPane.showMessageDialog(null, "Update Password Error = "+e);
    ...
    private void delete_jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delete_jButton1ActionPerformed
        ...
        int _id = -1;
        _id = sNo_jTextField.getText().isEmpty() ? -1 : Integer.parseInt(sNo_jTextField.getText());
        ...
        try {
            ...
            String sql = "DELETE FROM ALLPASSWORD WHERE id = '"+_id+"' ";
            stmt.executeUpdate(sql);
            ...
            System.out.println("Delete Password Error = "+e);
        }
    ...
    private void search_jButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_search_jButtonActionPerformed
        ...
        try {
            ...
            if(rs.next()){
                ...
                this.sNo = Integer.parseInt(idString);
